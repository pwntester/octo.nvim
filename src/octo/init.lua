require("octo.def_G")
require("octo.model.octo") -- import basic types
...
-- local record MT
--   setup: function(user_config: any)
--   configure_octo_buffer: function(bufnr: number)
--   save_buffer: function()
--   load_buffer: function(bufnr: number)
--   load: function(repo: string, kind: OctoKind, number: string, cb: function(obj: any))
--   render_signcolumn: function()
--   on_cursor_hold: function()

--   create_buffer: function(kind: OctoKind, obj: any, repo: any, create: boolean)
-- end
local M = {}
