...
query($endCursor: String) {
  repository(owner: "%s", name: "%s") {
    issues(first: 100, after: $endCursor, filterBy: {%s}, orderBy: {field: CREATED_AT, direction: DESC}) {
      nodes {
        __typename
        number
        title
...
query($endCursor: String) {
  repository(owner: "%s", name: "%s") {
    pullRequests(first: 100, after: $endCursor, %s, orderBy: {field: CREATED_AT, direction: DESC}) {
      nodes {
        __typename
        number
        title
